				...
				<div class="panel panel-default">
					<div class="panel-body">
						<div class="row">
							...
							<div class="col-lg-8"><input type="text" class="form-control input-xl" placeholder="Bukkit Slug" value="{{ $plugin->bukkit }}" disabled /> <a href="#deletePlugin" class="btn btn-danger btn-sm" data-plugin="{{ $plugin->name }}"><i class="fa fa-times-circle"></i></a></div>
						</div>
					</div>
				</div>
			</div>
