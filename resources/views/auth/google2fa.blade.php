...
@section('content')
    ...
    <div class="text-center">
        ...
        <br/>Scan this QR code into your authentication app (Authy, Google Auth, etc.) or enter the key manually. Afterwards, enter the number it gives you in the box below to
        confirm that your 2FA has
