<?php
	...
	return array(
		...
		'files-to-minify'      => array('laravel/public/assets/css/style.css', 'laravel/public/assets/js/admin.js', 'laravel/public/assets/js/scripts.js', 'laravel/public/assets/js/charts.js',),

		// What commands should we run before branch specific commands?
		// Use {branch} to specify a specific branch name
		'pre-commands'         => array('php laravel/artisan down', 'git stash', 'git pull origin {branch}',),
